classdef ProjectStartupApp < matlab.apps.AppBase
    ...
    properties (Access = private)
        ...
        GitHubRepository = "Numerical-Integration";
    end
...
%}
    ...
    methods (Access = private)
        ...
        function createComponents(app)
            ...
            app.WelcomeTitle.Text = 'Welcome to Numerical Integration';
            ...
            app.Image.ImageSource = 'integration.gif';
            ...
            app.ReviewTitle.Text = 'Welcome to Numerical Integration';
